...
class SphereTest {
    ...
    public void testFindIntersections() {
        ...
        assertEquals(2, sphere.findIntersections(new Ray(new Point3D(1, -3, 0), new Vector(0, 1, 0))).size(), "Wrong number of points");
        ...
        assertNull(sphere.findIntersections(new Ray(new Point3D(3, 0, 0), new Vector(0, 0, 1))), "Ray orthogonal to ray head to center line");
    }
}